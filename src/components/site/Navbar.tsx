    ...
    >
      <nav className="container-luxury flex items-center justify-between h-20">
        <a href="#home" className="flex items-center gap-3">
          <img src={logo} alt="AD Realty Properties" className="h-12 w-12 object-contain rounded-sm bg-white/90 p-1" />
          <div className="hidden sm:flex flex-col leading-tight">
            <span className={`font-display text-lg tracking-wide ${scrolled ? "text-navy" : "text-white"}`}>
              AD Realty
            </span>
            <span className={`text-[10px] tracking-[0.3em] uppercase ${scrolled ? "text-gold" : "text-gold"}`}>
              Properties
            </span>
          </div>
        </a>
